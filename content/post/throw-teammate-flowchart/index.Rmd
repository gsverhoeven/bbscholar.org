...
The updated Throw Teammate Flowchart for BB2025 can be downloaded [here](TTM Chart for BB2025.pdf) and the SVG source is available [here](TTM Chart for BB2025.svg) if you want to tinker with it in Inkscape (I used version 1.2).
