...
date: '2022-11-01'
bibliography: references/2022_clusterheatmap_blog_post.json
...
``` r
df_mbt <- read.csv(file = "fumbbl_datasets/df_mbt.csv")
...
```
    ...
    ##  [1] "race_name"       "race_type"       "team_score"      "away_team_score"
    ##  [5] "home_comp"       "home_pass"       "home_rush"       "home_block"     
    ##  [9] "home_foul"       "home_cas"        "away_comp"       "away_pass"      
    ## [13] "away_rush"       "away_block"      "away_foul"       "away_cas"
...
```
    ...
    ## ℹ Summaries were computed grouped by race_name and race_type.
    ## ℹ Output is grouped by race_name.
    ## ℹ Use `summarise(.groups = "drop_last")` to silence this message.
    ## ℹ Use `summarise(.by = c(race_name, race_type))` for per-operation grouping
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-10-1.png" alt="" width="768" />
...
``` r
# pak::pak("gsverhoeven/ggoheatmap")
library(ggoheatmap)
```
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-13-1.png" alt="" width="1344" />
...
<img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-14-1.png" alt="" width="1152" /><img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-14-2.png" alt="" width="1152" /><img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-14-3.png" alt="" width="1152" /><img src="{{< blogdown/postref >}}index_files/figure-html/unnamed-chunk-14-4.png" alt="" width="1152" />
...
Amiral, Taureau. 2017. “Blood Bowl Teams Strength.” *Blood Bowl Strategies*, November 24. <https://bloodbowlstrategies.com/en/relative-strength-of-teams/>.

</div>

<div id="ref-breidr15" class="csl-entry">

Breidr. 2015. “Cyanide - ‘Bashy’ Race Choice for League Play.” Blood Bowl Tactics Forum. <https://bbtactics.com/forum/threads/bashy-race-choice-for-league-play.4961/>.

</div>

<div id="ref-dode17" class="csl-entry">

Dode. 2017. “What Is the Bashiest Agility Team After Dark Elves? :: Blood Bowl 2 General Discussions.” <https://steamcommunity.com/app/236690/discussions/0/135512931355543270/>.

</div>

<div id="ref-ivanauskas20" class="csl-entry">

Ivanauskas, Tadas. 2020. *BloodBowl 2 race clustering by different playstyles*. <http://urn.kb.se/resolve?urn=urn:nbn:se:mau:diva-41540>.

</div>

<div id="ref-schlice18a" class="csl-entry">

Schlice. 2018. “Bash/Dash/Hybrid by the Numbers.” February 27. <http://www.nufflytics.com/post/bash-dash-hybrid-by-the-numbers/>.

</div>

<div id="ref-wilkinson_friendly09" class="csl-entry">

Wilkinson, Leland, and Michael Friendly. 2009. “The History of the Cluster Heat Map.” *The American Statistician* 63 (2): 179–84. <https://doi.org/10.1198/tas.2009.0033>.
